    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follow_type', models.IntegerField(blank=True, choices=[(1, '点赞'), (2, '收藏')], null=True)),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='zhihu.Answer', verbose_name='回答')),
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='zhihu.Question', verbose_name='问题'),
        ),
        migrations.AddField(
            model_name='userfollowquestion',
            name='user',
