...
urlpatterns = [
    ...
    path('resend_confirm_email/', resend_confirm_email,
    ...
    path('user/edit_profile/change_email_request/', change_email_request,
         name='change_email_request'),
    path('user/edit_profile/change_email/<str:token>/', change_email,
         name='change_email'),
